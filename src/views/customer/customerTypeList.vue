  ...
  <div class="role-wrap">
    <el-card>
      ...
      <el-row :gutter="20" class="role-top">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="newObj">+新建客人类型</el-button>
        </el-col>
      </el-row>
      <!--列表区域-->
      <el-table :data="tableData" class="table-box" border>
        <el-table-column label="客人类型ID" prop="id" align="center">
        </el-table-column>
...
<script  src="../../js/customer/customerTypeList.js"></script>
