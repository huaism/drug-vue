  ...
  <div class="role-wrap">
    <el-card>
      ...
      <el-row :gutter="20" class="role-top">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="newRole">+新建物资</el-button>
        </el-col>
      </el-row>
      <!--列表区域-->
      <el-table :data="tableData" class="table-box" border>
        <el-table-column label="物资ID" prop="id" align="center">
        </el-table-column>
        <el-table-column label="物资名" prop="name" align="center">
        </el-table-column>
    ...
    >
      <el-form
        ...
        label-width="80px"
      >
        <el-form-item label="物资名" prop="name">
          <el-input
