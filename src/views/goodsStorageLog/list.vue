  ...
  <div class="role-wrap">
    <el-card>
      ...
      <el-row :gutter="20" class="role-top">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="newObj">+新建物资操作</el-button>
        </el-col>
      </el-row>
      <!--列表区域-->
    ...
    >
      ...
      >
       ...
       <el-form-item label="选择物资" prop="goodsId">
          <el-select v-model="newForm.goodsId" placeholder="请选择物资">
            <el-option
...
<script  src="../../js/goodsStorageLog/list.js"></script>
